...
<div class="incontainer">
    <form action="update_internship_db_resume.jsp">
<div class="inheader">Edit Internship Details<a href="resume.jsp"><span class="inclose" style="font-weight:bold" title="close">&times;</span></a></div>
...
{   
    ...
    PreparedStatement stmt2=con.prepareStatement("select profile,organization,location,sdate,edate,wfh from student_internship_exp where s_id=?");
