...
{   
    ...
    PreparedStatement stmt2=con.prepareStatement("select stream,college,yoc,max_marks,obt_marks from college_edu_dip where s_id10=?");
...
<div class="dipheader">Diploma Details <a href="resume.jsp"><span class="dipclose" title="close" style="color:white;font-weight:bold">&times;</span></a></div>
