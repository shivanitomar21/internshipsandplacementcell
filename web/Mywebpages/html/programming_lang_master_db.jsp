...
<div id="maindiv">
	...
	<form id="lmodal-content animate"  action="programming_lang_master_db.jsp" >
...
<label id="ll02">Programming Language </label></br>
<input type="text" placeholder="Enter Programming Language" name="bname" id="lt02" required>
</br></br></br>
	...
	try
			{
				...
				PreparedStatement stmt1=con1.prepareStatement("insert into prog_language_master(l_name) values (?)");
...
%>
<label id="ll03">Programming Language Id</label></br>
<input type="text" placeholder="Enter Programming Language Id" name="pid" id="lt03" required>
<label id="ll04">Programming Language Name</label></br>
<input type="text" placeholder="Enter Programming Language Name" name="pname" id="lt04" required>
</br></br></br>
<%
	...
	try
			{
				...
				PreparedStatement stmt2=con2.prepareStatement("update prog_language_master set l_name=? where l_id=?");
