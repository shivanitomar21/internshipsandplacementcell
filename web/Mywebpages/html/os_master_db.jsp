...
<div id="maindiv">
	...
	<form id="lmodal-content animate"  action="os_master_db.jsp" >
...
<label id="ll02">Operating System Name </label></br>
<input type="text" placeholder="Enter Operating System Name" name="bname" id="lt02" required>
</br></br></br>
	...
	try
			{
				...
				PreparedStatement stmt1=con1.prepareStatement("insert into os_master(os_name) values (?)");
...
%>
<label id="ll03">Operating System Id</label></br>
<input type="text" placeholder="Enter Operating System Id" name="pid" id="lt03" required>
<label id="ll04">Operating System Name</label></br>
<input type="text" placeholder="Enter Operating System Name" name="pname" id="lt04" required>
</br></br></br>
<%
	...
	try
			{
				...
				PreparedStatement stmt2=con2.prepareStatement("update os_master set os_name=? where os_id=?");
