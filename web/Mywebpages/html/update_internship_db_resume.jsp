...
try{    
    ...
    PreparedStatement stmt1=con.prepareStatement("update student_internship_exp set profile=?,organization=?,location=?,wfh=?,sdate=?,edate=? where s_id=?");
    ...
    stmt1.setString(5,smonth);
    
    stmt1.setString(6,emonth);
