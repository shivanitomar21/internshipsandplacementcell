...
{   
    ...
    while(rs3.next())
    {
        ...
        %>
            ...
            <form action="update_pg_db_resume.jsp" id="pgform">
            <div class="pgheader">Post Graduation Details <a href="resume.jsp"><span class="pgclose" title="close" style="color:white;font-weight:bold">&times;</span></a></div>
