...
<form action="update_ug_db.jsp">
<div class="ugheader">Graduation Details <a href="student_resume_edu.jsp"><span class="ugclose" title="close" style="color:white;font-weight:bold">&times;</span></a></div>
