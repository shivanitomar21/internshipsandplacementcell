...
<div class="jcontainer">
        <form action="update_job_db_resume.jsp">
<div class="jheader">Edit Job Details<a href="resume.jsp"><span class="jclose" style="font-weight:bold" title="close">&times;</span></a></div>
...
{   
    ...
    PreparedStatement stmt1=con.prepareStatement("select profile,organization,location,sdate,edate,cwh from student_job_exp where s_id2=?");
