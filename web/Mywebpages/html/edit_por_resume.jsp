...
<div id="portotal">
<form action="update_pos_db_resume.jsp">
<div class="porcontainer">
    
<div class="porheader">Position Of Responsibility<a href="resume.jsp"><span class="porclose" title="close">&times;</span></a>
</div>
...
{   
    ...
    PreparedStatement stmt1=con.prepareStatement("select description from student_pos_oexp where s_id5=?");
