...
<div class="tcontainer">
    <form action="update_training_db.jsp">
...
{   
    ...
    PreparedStatement stmt2=con.prepareStatement("select program,organization,location,sdate,edate,online from student_training_oexp where serial_no=?");
