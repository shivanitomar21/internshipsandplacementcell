...
<div class="pjcontainer">
    <form action="update_project_db.jsp">
...
{  
   ...
   PreparedStatement stmt3=con.prepareStatement("select title,sdate,edate,description,c_ongoing from project_oexp where serial_no=?");
